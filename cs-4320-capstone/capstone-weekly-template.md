...
* **Project Title:**
* **Data Modality:** (tabular, image, audio, text, other)
* **Task Type:** (regression, classification, clustering, sequence modeling, etc.)
* **One-Sentence Goal:** What are you trying to predict, detect, or understand?
